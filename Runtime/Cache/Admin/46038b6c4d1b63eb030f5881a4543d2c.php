...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label" style="display: inline">价格<span class="check-tips"></label>
			<div class="controls" style="display: inline">
				<input type="text" class="text input-small" name="price" value="<?php echo ((isset($info["price"]) && ($info["price"] !== ""))?($info["price"]):''); ?>">
			</div>
			<label class="item-label">单位</label>
			<div class="controls">
				<select name="unit">
					<option value="0" <?php if(($info["unit"]) == "0"): ?>selected<?php endif; ?>>元/月</option>
					<option value="1" <?php if(($info["unit"]) == "1"): ?>selected<?php endif; ?>>万元</option>
				</select>
			</div>
		</div>
        <div class="form-item">
            ...
            <div class="controls">
				...
				<option value="1" <?php if(($info["type"]) == "1"): ?>selected<?php endif; ?>>售卖</option>
                </select>
            </div>
        </div>
		<div class="controls">
		...
		<textarea name="intro" style="width: 1100px;height: 200px;display: block"><?php echo ($info["intro"]); ?></textarea>
		<label class="item-label">截止日期</label>
		<input type="text" name="end_time" class="text time" value="<?php echo ((isset($info["end_time"]) && ($info["end_time"] !== ""))?($info["end_time"]):''); ?>" placeholder="请选择时间" />
		<div class="form-item">
