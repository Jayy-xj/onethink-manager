...
<div class="main">
    ...
    <div class="container-fluid">
        <?php if(is_array($services)): $i = 0; $__LIST__ = $services;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row noticeList">
...
<script type="application/javascript">
    var p = 1;
    var url = '/wchat.php/Service/service';
    var inner_url = '/wchat.php/Service/detail';
    $(function(){
