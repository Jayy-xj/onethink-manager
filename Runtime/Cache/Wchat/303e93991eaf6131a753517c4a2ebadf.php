...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/Public/Wchat/images/index.png" width="100%" />
        </div>
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    <div class="col-xs-4">
                        <a href="<?php echo U('Notice/notice');?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo U('Service/service');?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo U('Activity/notice');?>">
